...
void loop() {
  ...
  int changeRight = map(irRValue, rightMin, rightMax, 0,150);
  int changeLeft = map(irLValue, leftMin, leftMax, 0,150);
  if(irRValue>=1.5*rightAverage){servoLeft.writeMicroseconds(1500-changeLeft);}//what values are you reading, what are you doing here
  else{servoLeft.writeMicroseconds(1350);}
  if(irLValue>=1.5*leftAverage){servoRight.writeMicroseconds(1500+changeRight);}
  else{servoRight.writeMicroseconds(1650);}
