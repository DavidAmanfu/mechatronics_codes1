...
.ecu ICR1L , 0x86 ; also we can look at the analog comparator output for TCNT 1
.equ TIMSK1 , 0x6F
.equ TIFR1, 0x16
...
tccrsetup: 
	...
	sts TCCR1A , r16
	ldi r16, 0b00011001 ;no noise canceler, no prescaler, falling edge event
	sts TCCR1B , r16
	ldi r23 , 0x11
	ldi r24 , 0xde
...
acompsetup: 
	...
	ldi r16, 70
	sts PORTD, r16 ; setting AIN0 to value 70
...
ADC: ;called when adc conversion is completh
	in r16 , SREG ; Save the current status register to stack
	push r16
